...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        dim_out_conv_pool = num_filters * H * W // 4

        self.params['W2'] = weight_scale * np.random.randn(
            dim_out_conv_pool, hidden_dim
        )
    ...
    def loss(self, X, y=None):
        ...
        out_prime = out.reshape(N, -1)
        out_prime, affine_relu_cache = affine_relu_forward(out_prime, W2, b2)
        scores, affine_cache = affine_forward(out_prime, W3, b3)
